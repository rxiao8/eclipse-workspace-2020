...
//		t1.rabbits(32);
	...
	/*
	 * Steps to solving: Assume original is working and ask what it should do, not
	 * what it currently does Look at subproblems of it Make a connection between
	 * original and sub Find base case Combine
	 */
}
